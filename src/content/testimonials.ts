export const featuredTestimonial = {
  body: 'Keep Cool is the climate newsletter I look forward to reading. It’s interesting, researched, and highly informational with a unique perspective. Required reading whether in the climate space, or not!',
  author: {
    name: 'Lauren Singer',
